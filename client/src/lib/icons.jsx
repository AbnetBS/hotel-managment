const paths = {
  ...
  droplet: '<path d="M12 3s6 6.2 6 10.2a6 6 0 0 1-12 0C6 9.2 12 3 12 3Z"/>',
  layers: '<path d="m12 3 9 5-9 5-9-5 9-5ZM3 13l9 5 9-5M3 17l9 5 9-5"/>',
  shirt: '<path d="M8 3 4 5.5V11h3v10h10V11h3V5.5L16 3l-2 2h-4L8 3Z"/>',
  car: '<path d="M4 16V11l2-5h12l2 5v5M4 16h16M4 16v3h3v-3M17 16v3h3v-3"/><circle cx="7.5" cy="13.5" r="1.4"/><circle cx="16.5" cy="13.5" r="1.4"/>',
  ...
  'id-card': '<rect x="2.5" y="5" width="19" height="14" rx="2"/><circle cx="8.5" cy="11" r="2.2"/><path d="M5 16.4c.7-1.4 2-2.1 3.5-2.1s2.8.7 3.5 2.1M15 10h4M15 13.5h3"/>',
  'exchange': '<path d="M4 8h13l-3-3M20 16H7l3 3"/>',
  'droplet-off': '<path d="M12 3s6 6.2 6 10.2a6 6 0 0 1-9 5.2M6 8.5C6 9.5 6 12 6 13.2a6 6 0 0 0 3 5.2M4 4l16 16"/>',
